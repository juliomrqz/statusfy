...
import { NuxtConfigurationLoading } from '@nuxt/types/config/loading'
import { NuxtConfigurationModule } from '@nuxt/types/config/module'

import { ConfigFile, NuxtConfiguration } from "./interfaces";
import { loadConfig } from "./load";

const { colors } = style;

export function generateConfig(sourceDir: string, cliOptions: { [key: string]: string | boolean }): { nuxtConfig: NuxtConfiguration, siteConfig: ConfigFile } {
