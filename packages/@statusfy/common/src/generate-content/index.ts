...
const getDaySubtraction = (index: number) => {
...
const getId = (n: number, length: number) => n % length

const incidentTemplate = template(`---
id: <%= data.id %>
...
export const generateDemoContent = function generateDemoContent(dest: string, finalDate: string | number | Date, amount = 20) {
  // Empty Destination
