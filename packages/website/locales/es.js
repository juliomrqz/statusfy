export default {
  ...
  links: {
    documentation: {
      title: 'Documentación',
      url: 'https://docs.statusfy.co/es/'
    },
    demo: {
      title: 'Demostración',
      url: 'https://demo.statusfy.co/es'
    },
    getStarted: {
      title: 'Empezar',
      url: 'https://docs.statusfy.co/es/guide/'
    },
    learnMore: {
      title: 'Aprende Más'
    },
  ...
  features: {
    ...
    stack: {
      title: 'Stack Moderno',
      description:
        'Disfruta del poder de las tecnologías web modernas: <strong>Vue.js, Webpack y JavaScript </strong>. Escribe estilos CSS con tus preprocesadores favoritos como Sass, Less o Stylus con prefijo automático.'
    },
    customization: {
      title: 'Fácil Personalización',
      description:
        'Personaliza tu sistema con cualquier especificación de estilo que puedas necesitar. Utilice <strong>tu propio logotipo</strong> y fácilmente <strong>cambia el tema predeterminado</strong> con variables CSS o preprocesadores. Statusfy te permite <strong>mantener los requerimientos de tu marca</strong>.'
    },
    hosting: {
  ...
  blog: {
    title: 'Blog',
    description: 'Guías y Artículos acerca de Statusfy.',
    titleLatest: 'Últimas Publicaciones',
    on: 'el',
    readMore: 'Leer Más',
    ...
    feedback: {
      title: 'Comparte tus comentarios e ideas',
      introduction: 'Si tienes <strong>Informes de Errores</strong> o <strong>Solicitudes de Funcionalidades</strong>, utiliza la <a href="https://github.com/bazzite/statusfy/issues" target="_blank" rel="noopener">sección de Issues</a> o <strong>únete a la conversación</strong> en el <a href="{spectrum_chat}" target="_blank" rel="noopener">Chat de la Comunidad</a>.'
    }
  },
  support: {
    title: 'Soporte',
    ...
    community: {
      ...
      items: {
        ...
        questions: 'Si tienes alguna pregunta, ve al <a href="{spectrumchat_url}" target="_blank" rel="noopener">Chat de la Comunidad</a>.'
      }
    },
    email: {
