...
For any extra languages, locale-prefixed URLs will be generated. For example, suppose your Status Page System supports three languages: Spanish, French, and English as the default language. You will need to have the following page in your project:
